...
ActiveRecord::Schema.define(:version => 20111114164345) do
  ...
  add_index "abstract_courses", ["account_id"], :name => "index_abstract_courses_on_account_id"
  add_index "abstract_courses", ["enrollment_term_id"], :name => "index_abstract_courses_on_enrollment_term_id"
  ...
  create_table "assessment_questions", :force => true do |t|
    t.text     "name"
    t.text     "question_data",               :limit => 16777215
    t.integer  "context_id",                  :limit => 8
    t.string   "context_type"
    t.string   "workflow_state"
    t.datetime "created_at"
  ...
  add_index "content_exports", ["user_id"], :name => "index_content_exports_on_user_id"

  create_table "content_migrations", :force => true do |t|
    t.integer  "context_id",             :limit => 8
    t.integer  "user_id",                :limit => 8
    t.string   "workflow_state"
    t.text     "migration_settings",     :limit => 16777215
  ...
  create_table "courses", :force => true do |t|
    ...
    t.text     "syllabus_body",                        :limit => 2147483647
  ...
  create_table "error_reports", :force => true do |t|
    ...
    t.text     "http_env",           :limit => 2147483647
    t.string   "subject"
  ...
  create_table "page_views", :primary_key => "request_id", :force => true do |t|
    t.string   "session_id"
    t.integer  "user_id",              :limit => 8
    t.text     "url"
    t.integer  "context_id",           :limit => 8
  ...
  add_index "pseudonyms", ["account_id"], :name => "index_pseudonyms_on_account_id_and_sis_source_id"
  ...
  create_table "quiz_submissions", :force => true do |t|
    ...
    t.integer  "user_id",              :limit => 8
    t.text     "submission_data",      :limit => 2147483647
    t.integer  "submission_id",        :limit => 8
    t.float    "score"
    t.float    "kept_score"
    t.text     "quiz_data",            :limit => 2147483647
    t.datetime "started_at"
    t.datetime "end_at"
    t.datetime "finished_at"
    t.integer  "attempt"
  ...
  create_table "sis_batches", :force => true do |t|
    ...
    t.integer  "attachment_id",       :limit => 8
    t.integer  "progress"
    t.text     "processing_errors",   :limit => 2147483647
    t.text     "processing_warnings", :limit => 2147483647
  ...
  add_index "thumbnails", ["id", "uuid"], :name => "index_thumbnails_on_id_and_uuid"
